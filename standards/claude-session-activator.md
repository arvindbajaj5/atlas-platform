...
| Domain Configurator v2 | ✅ Live | `tools/domain-configurator/` |
...
| Project Brief in Domain Configurator | Not yet built |
| TAD in Inferencing Factory | Not yet built |
| Solution Presentation PPTX in Portfolio Portal | On hold |
| Second Brain domain files (geospatial.md first) | Not yet built |
| tool-features.md v1.1 visualisation standards | Not yet built |
